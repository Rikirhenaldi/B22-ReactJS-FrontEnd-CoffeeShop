...
class NavbarLog extends React.Component{
    render(){
        return(
            <nav class="w-full h-32 flex justify-between">
            <span class="flex flex-1 items-center">
            <figure class="ml-40 "><img src={logo} alt=""/></figure>
            <figcaption class="ml-4 text-lg font-bold">Coffee Shop</figcaption>
            </span>
            ...
            <ul class="listrightnav flex justify-center items-center space-x-8">
                <li class="flex justify-end font-medium text-3xl"><FiSearch size='25'/></li>
                <li class="flex flex-row  justify-end font-medium text-4xl rounded-full">
                    <Link to=""><img class="w-8" src={logoChat} alt=""/></Link>
                    <div class=" relative bottom-2 right-10 w-4 h-4 rounded-full bg-red-800 text-xs text-white flex justify-center items-center">1</div>
                </li>
                <li class="flex justify-end font-medium text-sm rounded-full"><Link to="/Profile"><img class="rounded-full w-8" src={userPict} alt=""/></Link></li>
            </ul>
        </nav>    
        )
    }
