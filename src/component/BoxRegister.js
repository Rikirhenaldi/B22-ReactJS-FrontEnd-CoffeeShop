            ...
            <div class="flex flex-col justify-between mb-16 mt-16">
                ...
                <div class="flex flex-col justify-center items-center">
                    <form action="" class="flex flex-col w-8/12">
                        <header class="mb-8 text-center text-3xl font-bold text-yellow-800">Sign Up</header>
                        ...
                        <label class="mb-2 font-bold text-lg" for="phoneNoumber">Phone Number :</label>
                        <input class="pl-8 border-2 rounded-2xl h-16 mb-10" type="text" name="PhoneNumber" id="" placeholder="Enter your phone number"/>
                        <button class="mb-4 bg-yellow-400 w-full h-16 rounded-2xl font-bold text-lg">Sign Up</button>
