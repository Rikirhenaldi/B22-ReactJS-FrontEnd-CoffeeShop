...
class BoxProvide extends React.Component{
    render(){
        return(
            ...
            <div class="mx-32">
                <header class="font-medium text-4xl mr-16 mb-6">We Provide Good Coffee and Healthy Meals</header>
                <p class="mb-6 leading-8"> You can explore the menu that we provide with fun and have their own taste and make your day better.</p>
                <ul class="leading-10">
                    <li className="flex flex-row items-center">
                        <BiCheckCircle class="text-green-400 mr-3" />
